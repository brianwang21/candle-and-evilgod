...
const ANOMALY_EVENTS_DB = {
  ...
  events: [
    ...
    {
      id: 'raven-witch-curse',
      name: '渡鴉魔女的詛咒',
      type: 'controlled',
      brief:
        '被異常事件「魔女們的餐桌」影響，導致左手臂長出羽毛狀的尖銳鱗片，左眼也一併遭受感染。能夠投擲羽毛來進行攻擊、或射擊羽毛來改變子彈行進軌跡。',
      detailBrief: '禍從口出……以及眼睛……還有左手。',
      detail: [
        { type: 'doc-title', text: '渡鴉魔女的詛咒_能力詳解' },
        { type: 'rule' },
        {
          type: 'p',
          text: '渡鴉魔女的詛咒是知無條例/段訊讀數-1＿魔女們的餐桌的後續影響，是一個 P/C 型的異常事件，其具體影響導致渡鴉的左手、左眼與在說出符合特定條件句子時的異常現象。',
        },
        {
          type: 'p',
          text: '渡鴉在適應這個異常後，將其作為自身的武器使用——即便她很討厭自己這副模樣。',
        },
        { type: 'h3', text: '關於感染' },
        { type: 'rule' },
        {
          type: 'p',
          text: '渡鴉魔女的詛咒對渡鴉的身體造成了三個影響：',
        },
        {
          type: 'list',
          items: [
        ...
        {
          type: 'p',
          text: '渡鴉的左手是類似器官的組織，可以自如的控制並隨時脫離出羽毛，因其排列方式接近生物鱗片；形狀接近硬鱗，學名上將其稱為『鱗羽』。',
        },
        {
          type: 'p',
          text: '羽毛整體長約十公分、寬約五公分，厚度約0.2公分。本體有著相當不錯的回彈硬度。',
        },
        {
          type: 'p',
          text: '渡鴉可以隨時從左手分離出羽毛並作為刃器使用，但這樣使用並不方便。她本人更喜歡將其當成飛刀來投擲。',
        },
        { type: 'h3', text: '左眼' },
        { type: 'rule' },
        {
          type: 'p',
          text: '渡鴉的左眼在病變後失去了原有人類的特徵，轉為剔透的、散發著淡紫光芒的軟質複眼。',
        },
        {
          type: 'figure',
          src: 'images/RAVEN/RAVEN_ability_leftEye.png',
          alt: '左眼結構示意圖',
          caption: '左眼結構示意圖',
        },
        {
          type: 'p',
          text: '其睫毛、眉毛、眼瞼等器官依舊存在，在X光觀察後確認為眼球本體及視神經發生病變。',
        },
        {
          type: 'p',
          text: '左眼的存在讓渡鴉能夠有著更廣闊的視野、更好的視力和視覺敏銳度。',
        },
        {
          type: 'p',
          text: '根據本人的說詞，在專注精神時，左眼看到的一切都像是在慢動作撥放。',
        },
        { type: 'h3', text: '烏鴉嘴' },
        { type: 'rule' },
        {
        ...
        {
          type: 'p',
          text: '「烏鴉嘴」是指渡鴉在使用特定句型、語法進行發言時所導致的異常現象。',
        },
        {
          type: 'p',
          text: '具有讓負面事件發生、將正面事件轉負的能力。',
        },
        {
          type: 'p',
          text: '達成該條件需要滿足以下項目：',
        ...
        {
          type: 'p',
          text: '如當前情況下存在兩種或兩種以上的方式去做某件事情，而其中一種選擇方式將導致災難，則必定有人會做出這種選擇。',
        },
        {
          type: 'p',
          text: '此外，該異常現象的詳細觸發條件仍然不清，連渡鴉本人也不知道這個異常的實際運作機制為何。',
        },
        { type: 'h3', text: '應用' },
        { type: 'rule' },
        {
          type: 'p',
          text: '在實戰上，渡鴉很少採取近身作戰的策略，她通常會跟對手保持一段距離，並運用地形、掩體與視覺死角等來隱藏自己的位置，而後投擲羽毛作為暗器無聲攻擊。',
        },
        {
          type: 'p',
          text: '在交戰中，她也會善用地形創造優勢，朝空中或牆壁甩出羽毛，在一瞬之內用自己的配槍射擊羽毛，使子彈在羽毛上方反彈並改變彈道。',
        },
        {
          type: 'p',
          text: '如果情況許可，她會朝空中撒出大量羽毛，讓射出的子彈命中羽毛並持續轉向，藉此達成混淆視覺與偷襲的效果。',
        },
        {
          type: 'p',
          text: '以及，如果欲射擊的目標身上已經附著羽毛，射擊對方身上的羽毛也能加強對該部位的破壞。',
        },
      ],
    },
  ],
  ...
  ownership: [
    ...
    { characterId: 'raven', eventId: 'raven-witch-curse' },
  ],
};
