  ...
  networks: {
    alaya: {
      ...
      nodes: [
        ...
        },
        {
          ...
          name: '渡鴉',
          role: '教官',
          image: 'images/RAVEN/RAVEN_Head_.png',
          x: -400,
          y: 280,
        },
        {
      ...
      edges: [
        ...
        { from: 'alaya', to: 'raven', label: '教官', feeling: '好閨密' },
    ...
    cae: {
      ...
      edges: [
        ...
        { from: 'cae', to: 'raven', label: '同事', feeling: '有用的東西' },
    ...
    raven: {
      ...
      edges: [
        { from: 'raven', to: 'cae', label: '同事', feeling: '迷戀' },
        { from: 'raven', to: 'alaya', label: '新來的', feeling: '想要更加了解' },
        { from: 'raven', to: 'magpie', label: '同事', feeling: '損友' },
        { from: 'raven', to: 'shrike', label: '同事', feeling: '過度興奮的小鬼頭' },
        { from: 'raven', to: 'morris', label: '所屬' },
      ],
    },
  },
};
